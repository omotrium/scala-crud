...
class DeleteProfileControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting with ScalaFutures {
  ...
  val profileController = inject[DeleteProfileController]

  "DeleteProfileController" should {
