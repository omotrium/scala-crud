...
class UpdateProfileControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting with ScalaFutures {
  ...
  val profileController = inject[UpdateProfileController]
